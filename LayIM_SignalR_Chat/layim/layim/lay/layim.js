...
; !function (win, undefined) {
    ...
    xxim.popchat = function (param) {
        ...
        log.html = '<div class="layim_chatbox" id="layim_chatbox">'
                ...
                + '       <div class="upload"> <a href="javascript:;"><i class="layim_addimage" title="上传图片"><form id="filePostImage" action="/Home/UploadFile" method="post" enctype="multipart/form-data"><input type="file" name="file" class="upload-input" accept="image/*" onchange="save(true)" value="" data-type="jpg,gif,png,bmp,jpeg" data-size="50" /></form></i></a>'
                + '        <a href="javascript:;"><i class="layim_addfile" title="上传附件"><form id="filePostFile" action="/Home/UploadFile" method="post" enctype="multipart/form-data"><input type="file" class="upload-input" name="file" onchange="save(false)" value="" /></form></i></a></div>'
